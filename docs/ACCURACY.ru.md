# Точность и внутреннее устройство

Насколько хорошо симулятор предсказывает бой, как это измерено, чего в нём ещё
нет и какими инструментами это выясняется.

[English version](ACCURACY.md) · [назад к README](../README.ru.md)
...
### Измерено на реальных боях из твоих логов
